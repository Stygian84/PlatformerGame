...
public class RangedEnemy : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Transform fireballsHolder = parentTransform.Find("EnemyProjectileHolder");

            if (gameObject.name == "Boss")
            {
                fireballsHolder = parentTransform.Find("BossProjectileHolder");
            }
    ...
    void Update()
    {
        ...
        if (enemyPatrol != null)
        {
            ...
            anim.SetBool("moving", !PlayerInSight());
        }
    }
